...
from colabdesign.shared.utils import copy_dict, clear_mem
...
def plot_me(
    ...
    **kwargs,
    ...
    plt.scatter(
        x_vals, y_vals, c=c * 0.75, s=5, vmin=0, vmax=1, cmap="gist_rainbow", **kwargs
    )
...
class af2rank:
    def __init__(
        self, pdbname, pdb=None, chain=None, model_name="model_1_ptm", model_names=None
    ):
        self.args = {
            "pdb": pdb,
            "pdbname": pdbname,
    ...
    def predict(
        ...
        feature_file = Path(
            f"/home/yubeen/commat_revision/af2rank/h3index/{pdbname}_h3loop.npy"
        )
