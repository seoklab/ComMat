...
import json
import pandas as pd
from colabdesign.AF2rank import af2rank
from colabdesign.AF2rank import plot_me
...
def get_af2rank(
    ...
    af = af2rank(name, None, CHAIN, model_name=SETTINGS["model_name"])

    score_dict = {}
    SCORES = []
    # score native structure
    # SCORES.append(af.predict(None, **SETTINGS, extras={"id": None}, types="native"))
...
if __name__ == "__main__":
    ...
    scores, scores_dict = get_af2rank(
        args.name,
        args.chain,
        args.decoy_dir,
